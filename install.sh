#!/usr/bin/env sh
# Universal installer for mcpharden. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/mcpharden.git"
echo "Installing mcpharden ..."
